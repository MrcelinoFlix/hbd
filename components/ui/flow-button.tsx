...
export function FlowButton({ text = "Modern Button", onClick }: FlowButtonProps) {
  return (
    ...
    >
      ...
      {/* Circle - Diperbesar ukurannya agar menutupi seluruh tombol dan diubah warnanya */}
      <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 bg-[#9333ea] rounded-[50%] opacity-0 group-hover:w-[500px] group-hover:h-[500px] group-hover:opacity-100 transition-all duration-[800ms] ease-[cubic-bezier(0.19,1,0.22,1)]"></span>
